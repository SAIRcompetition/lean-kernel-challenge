# Stage 1 — Competition Rules

These are the detailed rules for Stage 1. See the [series overview](overview.md),
[key dates](prelaunch.md#key-dates), and [problem and scoring guide](problems/README.md)
for background, the schedule, and individual tasks.
...
Formal submissions follow the tentative launch and deadline in the
[published key dates](prelaunch.md#key-dates). The workspaces and existing evaluation
