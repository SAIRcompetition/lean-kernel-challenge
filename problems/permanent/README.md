...
`∀ n, impl n = permanentSpecN n`. The starting implementation and proof already work.
See the [problem statement](../../rules/problems/permanent.md) for the input, output,
and scoring rules.
...
the fixed [evaluation workspace](../../evaluation/problems/permanent/).
