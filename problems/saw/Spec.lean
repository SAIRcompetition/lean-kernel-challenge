...
The number of self-avoiding walks of length `sawInstance` on the square
lattice ℤ², starting at the origin. Specified by brute-force extension of all
walks. Deliberately exhaustive; submissions are expected to count faster
(symmetry reduction, better data structures) and prove the count against
this spec.
-/
