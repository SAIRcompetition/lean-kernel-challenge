...
`∀ n, impl n = sha256Spec n`. The starting implementation and proof already work.
See the [problem statement](../../rules/problems/sha256.md) for the input, output,
and scoring rules.
...
the fixed [evaluation workspace](../../evaluation/problems/sha256/).
