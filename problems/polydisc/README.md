...
`∀ n, impl n = discSpec n`. The starting implementation and proof already work.
See the [problem statement](../../rules/problems/polydisc.md) for the input, output,
and scoring rules.
...
the fixed [evaluation workspace](../../evaluation/problems/polydisc/).
