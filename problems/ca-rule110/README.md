...
`∀ n, impl n = caSpecN n`. The starting implementation and proof already work.
See the [problem statement](../../rules/problems/ca-rule110.md) for the input, output,
and scoring rules.
...
the fixed [evaluation workspace](../../evaluation/problems/ca-rule110/).
