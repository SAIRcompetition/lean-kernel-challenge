# Prime counting — participant workspace

Edit only `Submission.lean`: implement your algorithm and prove
`∀ n, impl n = primeCountSpec n`. The starting implementation and proof already work.
See the [problem statement](../../rules/problems/primecount.md) for the input, output,
and scoring rules.
